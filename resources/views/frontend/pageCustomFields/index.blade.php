        ...
        <div class="col-md-12">
            @can('page_custom_field_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.page-custom-fields.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $pageCustomField->id }}">
                                        ...
                                        <td>
                                            @can('page_custom_field_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.page-custom-fields.show', $pageCustomField->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('page_custom_field_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.page-custom-fields.edit', $pageCustomField->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('page_custom_field_delete')
                                                <form action="{{ route('frontend.page-custom-fields.destroy', $pageCustomField->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('page_custom_field_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.page-custom-fields.massDestroy') }}",
