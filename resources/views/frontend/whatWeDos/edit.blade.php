    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.what-we-dos.update", [$whatWeDo->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="title">{{ trans('cruds.whatWeDo.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $whatWeDo->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="excerpt" id="excerpt">{{ old('excerpt', $whatWeDo->excerpt) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="page_text" id="page_text">{!! old('page_text', $whatWeDo->page_text) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cta_button_text" id="cta_button_text" value="{{ old('cta_button_text', $whatWeDo->cta_button_text) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cta_url" id="cta_url" value="{{ old('cta_url', $whatWeDo->cta_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="slug" id="slug" value="{{ old('slug', $whatWeDo->slug) }}">
                            @if($errors->has('slug'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('slug') }}
                                </div>
