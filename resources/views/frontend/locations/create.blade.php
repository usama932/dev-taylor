                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.locations.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location_country" id="location_country" value="{{ old('location_country', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location_phone" id="location_phone" value="{{ old('location_phone', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="location_address" id="location_address">{{ old('location_address') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location_addlink" id="location_addlink" value="{{ old('location_addlink', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="orderby" id="orderby" value="{{ old('orderby', '') }}" step="1">
