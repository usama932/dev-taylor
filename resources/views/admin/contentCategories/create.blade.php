        ...
        <form method="POST" action="{{ route("admin.content-categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <div class="form-group">
                    <label class="required" class="text-xs " for="name">{{ trans('cruds.contentCategory.fields.name') }}</label>
            ...
            <div class="mb-3">
                <div class="form-group">
                    <label for="slug" class="text-xs ">{{ trans('cruds.contentCategory.fields.slug') }}</label>
