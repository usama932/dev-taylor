    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.locations.update", [$location->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location_country') ? 'is-invalid' : '' }}" type="text" name="location_country" id="location_country" value="{{ old('location_country', $location->location_country) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location_phone') ? 'is-invalid' : '' }}" type="text" name="location_phone" id="location_phone" value="{{ old('location_phone', $location->location_phone) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('location_address') ? 'is-invalid' : '' }}" name="location_address" id="location_address">{{ old('location_address', $location->location_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location_addlink') ? 'is-invalid' : '' }}" type="text" name="location_addlink" id="location_addlink" value="{{ old('location_addlink', $location->location_addlink) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('orderby') ? 'is-invalid' : '' }}" type="number" name="orderby" id="orderby" value="{{ old('orderby', $location->orderby) }}" step="1">
