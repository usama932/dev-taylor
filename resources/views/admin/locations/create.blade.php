        ...
        <div class="flex-auto px-4 lg:px-10 py-10 pt-0 bg-blueGray-100">
            <form method="POST" action="{{ route("admin.locations.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control  border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150 {{ $errors->has('location_phone') ? 'is-invalid' : '' }}" type="text" name="location_phone" id="location_phone" value="{{ old('location_phone', '') }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input class="form-control  border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150 {{ $errors->has('orderby') ? 'is-invalid' : '' }}" type="number" name="orderby" id="orderby" value="{{ old('orderby', '') }}" step="1">
