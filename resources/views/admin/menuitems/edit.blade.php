    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.menuitems.update", [$menuitem->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $menuitem->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_to') ? 'is-invalid' : '' }}" type="text" name="link_to" id="link_to" value="{{ old('link_to', $menuitem->link_to) }}">
