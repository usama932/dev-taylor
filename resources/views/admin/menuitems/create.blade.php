      ...
      <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
        ...
        <div class="flex-auto px-4 lg:px-10 py-10 pt-0 bg-blueGray-100">
            ...
            <div class="form-group mb-3 mt-3" >
                <label for="name" class="block uppercase text-blueGray-600 text-xs font-bold mb-2">{{ trans('cruds.menuitem.fields.name') }}</label>
            ...
            <div class="form-group mb-3">
                <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="menu_id" class="block uppercase text-blueGray-600 text-xs font-bold mb-2">{{ trans('cruds.menuitem.fields.menu') }}</label>
            ...
            <div class="form-group mb-3" >
                <label for="page_link_id" class="block uppercase text-blueGray-600 text-xs font-bold mb-2">{{ trans('cruds.menuitem.fields.page_link') }}</label>
            ...
            <div class="form-group mb-3">
                <label for="link_to" class="block uppercase text-blueGray-600 text-xs font-bold mb-2">{{ trans('cruds.menuitem.fields.link_to') }}</label>
                <input class="form-control  border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150 {{ $errors->has('link_to') ? 'is-invalid' : '' }}" type="text" name="link_to" id="link_to" value="{{ old('link_to', '') }}">
            ...
            <div class="form-group mb-3">
                <label for="parent_id" class="block uppercase text-blueGray-600 text-xs font-bold mb-2">{{ trans('cruds.menuitem.fields.parent') }}</label>
