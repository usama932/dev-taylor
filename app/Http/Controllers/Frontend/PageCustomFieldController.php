...
class PageCustomFieldController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.pageCustomFields.index', compact('pageCustomFields'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.pageCustomFields.create', compact('case_study_customs', 'knowledge_customs', 'pages', 'team_customs', 'what_we_dos'));
    }
    ...
    public function store(StorePageCustomFieldRequest $request)
    {
        ...
        return redirect()->route('frontend.page-custom-fields.index');
    }
    ...
    public function edit(PageCustomField $pageCustomField)
    {
        ...
        return view('frontend.pageCustomFields.edit', compact('case_study_customs', 'knowledge_customs', 'pageCustomField', 'pages', 'team_customs', 'what_we_dos'));
    }
    ...
    public function show(PageCustomField $pageCustomField)
    {
        ...
        return view('frontend.pageCustomFields.show', compact('pageCustomField'));
    }
