...
class ContentPageController extends Controller
{
    ...
    public function index()
    {
        ...
        $contentPages = ContentPage::with(['categories', 'parent', 'tags', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.contentPages.create', compact('parents'));
    }
    ...
    public function edit(ContentPage $contentPage)
    {
        ...
        $contentPage->load('categories', 'parent', 'tags');

        return view('frontend.contentPages.edit', compact('contentPage', 'parents'));
    }
