...
$(document).ready(function () {
  ...
  $('#showLeftMap').click(function () {
    $(this).siblings(".leftMap").addClass('show');
  });
  $('#showRightMap').click(function () {
    $(this).siblings(".rightMap").addClass('show');
  });
  $('#hideLeftMap').click(function () {
    $(this).parent().parent().parent().find(".leftMap").removeClass('show');
  });
...
//# sourceMappingURL=/main.a1f4cdab.js.map